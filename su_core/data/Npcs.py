...
class Npc(Enum, metaclass=MyEnumMeta):
    Skeleton = 0
    Returned = 1
    BoneWarrior = 2
    BurningDead = 3
...
class UselessNpc(Enum, metaclass=MyEnumMeta):
    Chicken = 149
    Rat = 151
    Rogue = 152
    HellMeteor = 153
    ...
    #  428 #DruidBear
    BaalThrone = 543
    InjuredBarbarian = 467
    InjuredBarbarian2 = 568
    InjuredBarbarian3 = 569
    DemonHole = 711


class PlayerMinionNpc(Enum, metaclass=MyEnumMeta):
    ClayGolem = 289
    BloodGolem = 290
    IronGolem = 291
    FireGolem = 292
...
class MercNpc(Enum, metaclass=MyEnumMeta):
    roguehire = 271
    act2hire = 338
    act3hire = 359
    act5hire1 = 560
